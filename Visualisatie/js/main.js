...
function configSigmaElements(config) {
    ...
    var a = [],
        b,x=1;
		for (b in sigInst.clusters) a.push('<div style="line-height:12px"><a href="#' + b + '"><div style="width:40px;height:12px;border:1px solid #fff;background:' + b + ';display:inline-block"></div> Group ' + (sigInst.clusterTitles[b]) + ' (' + sigInst.clusters[b].length + ' members)</a></div>');
    //a.sort();
